    ...
    <>
      <nav className="absolute top-0 left-0 w-full flex items-center justify-between px-6 md:px-20 py-4 shadow-md bg-blue-500 z-50">
        ...
        <div className="hidden md:flex gap-6 items-right">
          <Link href="/upload-bukti" className="px-3 py-2 rounded hover:bg-blue-700 hover:text-white text-white transition">Upload Bukti</Link>
          <button
      ...
      {isMenuOpen && (
        <div className="absolute top-20 left-0 w-full bg-blue-500 flex flex-col gap-4 px-6 py-4 md:hidden z-40">
          <Link href="/" onClick={() => setIsMenuOpen(false)} className="text-white">Beranda</Link>
          <Link href="/booking" onClick={() => setIsMenuOpen(false)} className="text-white">Booking</Link>
          <Link href="/tentang" onClick={() => setIsMenuOpen(false)} className="text-white">Tentang</Link>
          <Link href="/upload-bukti" onClick={() => setIsMenuOpen(false)} className="text-white">Upload Bukti</Link>
          <button
            onClick={() => {
              setIsCartOpen(true);
              setIsMenuOpen(false);
